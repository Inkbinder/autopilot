...
- `gh` authenticated against GitHub, because the bundled GitHub, clarify, push, and land skills use it for issue, PR, label, check, merge, and clarification operations
